...
def main():
    ...
    # Lower default energy threshold for distant speech
    recorder.energy_threshold = args.energy_threshold if args.energy_threshold else 200
    # Enable dynamic energy threshold for better adaptation to background noise
    ...
    # Load / Download model
    model = args.model
    # Do not append .en, use multilingual model for Spanish
    ...
    # Use the source only for ambient noise adjustment
    with source:
    ...
    def record_callback(_, audio:sr.AudioData) -> None:
        ...
        data_queue.put(data)
        print("[DEBUG] Audio data received and added to queue.")

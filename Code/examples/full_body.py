...
body = QuadPilotBody("192.168.137.163")
...
body.set_pins(motor=MOTOR_INDEX, ENCODER_A=45, ENCODER_B=48, IN1=90, IN2=90)
body.set_control_status(motor=MOTOR_INDEX, status=False)  # Enable control for motor 0
...
def sse_listener():
    url = "http://192.168.137.163:82/events"
    while True:
